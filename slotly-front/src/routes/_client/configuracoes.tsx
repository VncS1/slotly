...
// Adapte o caminho da rota conforme sua estrutura para o cliente
export const Route = createFileRoute("/_client/configuracoes")({
...
export function SettingsPage() {
  ...
  const onSubmit = (data: any) => {
    // TECH LEAD TIP: Removemos o campo 'bio' aqui, pois clientes não possuem biografia [cite: 2026-01-21].
    const payload: any = {
      name: data.name,
      phone: data.phone,
    };

    // Só envia os dados de senha se o usuário realmente preencheu o campo de nova senha
        ...
        >
          <section className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8">
              ...
              <InputField
                ...
                type="email"
                disabled // E-mail geralmente não é alterado diretamente sem validação extra
                error={errors.email}
                {...register("email")}
              />
              <InputField
          ...
          <section className="space-y-6">
            ...
            <div className="space-y-4">
              <ToggleItem
                ...
                description="Receba um aviso no e-mail 24 horas antes do seu agendamento."
                defaultChecked
              />
              <ToggleItem
                label="Notificações por SMS"
                description="Receba mensagens de texto para confirmações e lembretes rápidos."
              />
            </div>
          </section>
          ...
          <div className="pt-8 sm:pt-10 border-t border-gray-100 flex justify-end items-center gap-6 sm:gap-8">
            ...
            <button
              ...
              className="bg-[#20C997] hover:bg-[#18A078] text-white px-8 sm:px-10 py-3 sm:py-4 rounded-2xl font-black shadow-lg shadow-[#20C997]/20 transition-all active:scale-95 disabled:opacity-50 flex items-center gap-2"
            >
...
function InputField({ label, error, ...props }: any) {
  return (
    <div className="flex flex-col gap-2.5 w-full">
      ...
      <input
        className={`w-full bg-gray-50 border rounded-2xl px-5 py-4 text-gray-700 font-medium outline-none transition-all disabled:opacity-50 disabled:cursor-not-allowed
